...
export const PRODUCTS: ShopProduct[] = [
  ...
  },
  {
    ...
    pl: {
      ...
      desc: "Limitowana edycja: 369 osób, 369 kawałków jednej układanki. Każdy dostaje własną, prostą stronę-wizytówkę zbudowaną na podstawie ankiety, a jednocześnie staje się puzzlem w większym obrazie. W Sylwestra 2026 ogłaszamy wyniki dopasowań — do kogo z tych 369 osób pasujesz. Cena katalogowa 1200 zł; z kodem PUZZLE369 (rabat 90%) zapłacisz 120 zł. Kupon limitowany: tylko 3 sztuki — trzy pierwsze osoby z kodem PUZZLE3 płacą dokładnie 12 zł zamiast 1200 zł. Warunek tej ceny: promocja Konstelacja.org w social mediach — publikacja informacji o projekcie Puzzle 369 z oznaczeniem @Konstelacja.org i linkiem do konstelacja.org. Po zakupie wypełnij brief, żeby mogła powstać Twoja wirtualna wizytówka.",
      impact: "Finansuje budowę wspólnej mapy dopasowań 369 osób i ich stron.",
      spec: [["Limit", "369 sztuk"], ["Rabat", "PUZZLE369 = −90% (120 zł)"], ["Kupon limitowany 3 szt.", "PUZZLE3 = 12 zł zamiast 1200 zł"], ["Warunek kodu PUZZLE3", "Post w social media o Konstelacja.org z linkiem i oznaczeniem"], ["Wyniki dopasowań", "Sylwester 2026"], ["Wymagane", "Wypełniony brief (ankieta)"], ["Wysyłka", "Brak — produkt cyfrowy/usługa"]],
    },
    en: {
      name: "Puzzle 369 — your unique one-page site",
      desc: "A limited run: 369 people, 369 pieces of one puzzle. Everyone gets a simple personal landing page built from a short survey — and becomes a piece of a bigger picture. On New Year's Eve 2026 we reveal the matches: who among the 369 fits you. List price 1200 PLN; with code PUZZLE369 (90% off) you pay 120 PLN. Limited coupon: only 3 units — the first three people using PUZZLE3 pay exactly 12 PLN instead of 1200 PLN. Condition for this price: promote Konstelacja.org on social media — post about the Puzzle 369 project tagging @Konstelacja.org with a link to konstelacja.org. After purchase, fill in the brief so your virtual card can be built.",
      impact: "Funds the shared matching map of 369 people and their pages.",
      spec: [["Limit", "369 units"], ["Discount", "PUZZLE369 = −90% (120 PLN)"], ["Limited coupon, 3 units", "PUZZLE3 = 12 PLN instead of 1200 PLN"], ["PUZZLE3 condition", "Social media post about Konstelacja.org with link and tag"], ["Match results", "New Year's Eve 2026"], ["Required", "Completed brief (survey)"], ["Shipping", "None — service"]],
    },
