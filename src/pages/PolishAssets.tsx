...
const PolishAssets = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="PolishAssets.com" description="PolishAssets.com — platforma waloryzacji aktywów — piramida wartości, tokenizacja i promocja polskich innowacji na arenie międzynarodowej." path="/polishassets" image="/og/polishassets.jpg" />
      ...
      {/* Final Statement — Homo Predictus Manifesto */}
      <section className="container max-w-3xl px-4 pb-20">
        <motion.div
          initial="hidden"
          whileInView="visible"
          ...
          variants={fadeUp}
          custom={0}
          className="rounded-2xl border border-accent/30 bg-gradient-to-br from-accent/10 to-primary/5 p-8 md:p-12"
        >
          <div className="text-center mb-8">
          ...
          <div className="flex flex-wrap gap-3 justify-center text-xs font-semibold mt-8">
