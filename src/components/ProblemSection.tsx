      ...
      <div className="container max-w-5xl">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mt-4 italic">
            Potrzeba jest matką wynalazku — <span className="text-foreground font-semibold">InventorProof.com</span> i <span className="text-foreground font-semibold">MindMark™</span> powstały właśnie dlatego, że ich twórczyni sama doświadczyła kradzieży technologii i braku narzędzi ochrony na etapie pre-patentowym.
          </p>
        </motion.div>
      </div>
    </section>
